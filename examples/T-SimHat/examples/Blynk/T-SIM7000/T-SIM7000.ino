...
void SIM7000modem_on()
{
    SerialAT.begin(SIM7600_UART_BAUD, SERIAL_8N1, SIM7000_RX_PIN, SIM7000_TX_PIN);
    delay(100);
    ...
    Serial.println("****\n");
    if (reply) {
        Serial.println("SIM7600_Mode normal");
    } else {
        Serial.println("SIM7600_Mode abnormal");
    }
