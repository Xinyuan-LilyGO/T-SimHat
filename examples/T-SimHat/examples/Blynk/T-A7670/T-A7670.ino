...
#define A7670_UART_BAUD    115200
#define RS485_UART_BAUD    115200
#define A7670_TX_PIN       26
#define A7670_RX_PIN       27
#define A7670_PWR_PIN      4
#define A7670_RI_PIN       33
#define A7670_PIN_DTR      25
#define A7670_RESET_PIN    5
...
void A7670modem_on()
{
    SerialAT.begin(A7670_UART_BAUD, SERIAL_8N1, A7670_RX_PIN, A7670_TX_PIN);
    delay(100);
    ...
    digitalWrite(A7670_RESET_PIN, LOW);
    delay(100);
    digitalWrite(A7670_RESET_PIN, HIGH);
    delay(1000);
    digitalWrite(A7670_RESET_PIN, LOW);
    ...
    Serial.println("****\n");
    if (reply) {
        Serial.println("A7670_Mode normal");
    } else {
        Serial.println("A7670_Mode abnormal");
    }
